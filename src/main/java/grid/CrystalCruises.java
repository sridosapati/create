...
public class CrystalCruises {
	...
	public void crystalCruises() throws InterruptedException, MalformedURLException {
		...
		//syntex for grid...browsers you can change...
		DesiredCapabilities dc = new DesiredCapabilities();
		dc.setBrowserName("chrome");
		dc.setPlatform(Platform.WINDOWS);
		
		RemoteWebDriver driver = new RemoteWebDriver(
				new URL("http://192.168.1.56:4444/wd/hub"), dc);//have to conform this from hub..ip address..N n.o of nodes can be connected
